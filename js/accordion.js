...
var QDR = (function(QDR) {
  ...
  // controller for the Add User input and button
  QDR.module.controller('QDR.addGroupCtrl', function ($scope, $rootScope, $timeout) {
      $scope.data = {
        addAGroup: '',
      };
      $scope.addGroup = function () {
        if ($scope.data.addAGroup && $scope.data.addAGroup.trim() !== '') {
          $timeout( function () {
            var d = {name: $scope.data.addAGroup, users: '', type: 'group', parent: $scope.formData.parent}
  ...
  // controller for the Source/Target accordion section
  QDR.module.controller('QDR.sourceCtrl', function ($scope, $timeout, $uibModal, uiGridConstants) {
    ...
    var generateColumns = function (groups) {
      ...
      groups.forEach( function (group) {
        $scope.sourceGrid.columnDefs.push({name: group.name,
          displayName: group.name,
          width: width,
          cellTemplate: "srcTrgTmpl.html"})
      })
    }
  ...
  // controller for the User/Group accordion section
